    ...
    <div id="filterDropdown" class="z-10 hidden px-3 pt-1 bg-white rounded-lg shadow w-80 dark:bg-gray-700 absolute top-full right-0 mt-1">
        <div class="flex items-center justify-between pt-2">
            ...
            <div class="flex items-center space-x-3">
                <a href="#" id="clearAllFilters" class="flex items-center text-sm font-medium text-primary-600 dark:text-primary-500 hover:underline">Clear all</a>
            </div>
        </div>
        <div class="pt-3 pb-2">
            <!-- Ville Filter -->

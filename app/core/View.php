        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900 shadow-md">
            ...
            <img src="<?= ROOT ?>public/assets/images/logo.png" class="h-12" alt="Association El Mountada Logo" />
                ...
                <div class="flex items-center space-x-6 rtl:space-x-reverse">
                    ...
                    <?php else: ?>
                        <a href="<?= ROOT ?>register" class="text-lg font-semibold text-primary hover:text-primary-hover transition duration-300">S'inscrire</a> <!-- Utilisation de la couleur primary -->
